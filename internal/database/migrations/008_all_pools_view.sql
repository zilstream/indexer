...
COMMENT ON VIEW dex_pools IS 'Unified view of all DEX pools across Uniswap V2 (pairs) and Uniswap V3 (pools), with 24h volume and last activity. V3 includes reserve0/reserve1 and an approximate liquidity_usd.';
